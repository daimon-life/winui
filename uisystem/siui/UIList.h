...
public:
	...
	virtual bool IsMultipleSele() const = 0;
	virtual bool ItemIsFolder(int iIndex) = 0;
	virtual bool ItemIsSelect(int iIndex) = 0;
    virtual bool SelectItem(int iIndex, bool bTakeFocus = false) = 0;
	virtual bool SelectMultipleItem(int iIndex, bool bTakeFocus = false) = 0;
	virtual bool DelSelectMultipleItem(int iIndex, bool bTakeFocus = false) = 0;
	virtual void GetMultipleSeleList(vector<DWORD>& indexs) = 0;
    virtual void DoEvent(TEventUI& event) = 0;
	virtual void DoSubEvent(CControlUI* pcontrol,TSUBEventUI& event) = 0;
};
...
public:
	...
	virtual bool SelectMultiple(bool bSelect = true) = 0;
...
{
protected:
    typedef std::vector<DWORD> vtDWORD;
    typedef std::vector<DWORD>::iterator vtDWORDIt;
...
public:
	...
	void SetEnabledChild(bool benable);
    bool GetScrollSelect();
    void SetScrollSelect(bool bScrollSelect);
    int GetCurSel() const;
	bool IsMultipleSele() const;
    bool SelectItem(int iIndex, bool bTakeFocus = false);
	bool SelectMultipleItem(int iIndex, bool bTakeFocus = false);
	bool DelSelectMultipleItem(int iIndex, bool bTakeFocus = false);
	void GetMultipleSeleList(vector<DWORD>& indexs);

    CListHeaderUI* GetHeader() const;  
    CContainerUI* GetList() const;
    TListInfoUI* GetListInfo();
	bool ItemIsFolder(int iIndex);
	bool ItemIsSelect(int iIndex);

	void DoSubEvent(CControlUI* pcontrol,TSUBEventUI& event);//响应子控件的操作
	...
	void SetEnableMultipleSele(bool enable = false);
	...
	void	DoHeadItemEvent(TEventUI& event);
	void	SortItemWidth(); //用来操作拉伸的时候处理
protected:
	...
	///--
	bool		m_isMultipleSele;
	vtDWORD 	*m_pCurrentSelectList;
};
...
public:
	...
	bool SelectMultiple(bool bSelect = true);
