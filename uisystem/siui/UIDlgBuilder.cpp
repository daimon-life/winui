    ...
    for( CMarkupNode node = pRoot->GetChild() ; node.IsValid(); node = node.GetSibling() ) {
        ...
        if( _tcscmp(pstrClass, _T("Include")) == 0 ) {
            ...
            case 7:
				...
				else if( _tcscmp(pstrClass, _T("XLayout")) == 0 )            pControl = new CXLayout;
                break;
            case 8:
            ...
            case 9:
				...
				else if (_tcscmp(pstrClass, _T("Animation")) == 0)			pControl=new CShowAnimation;
				else if (_tcscmp(pstrClass, _T("SpliteWnd")) == 0)			pControl=new CXHitTestControl;
                break;
            case 10:
			...
			case 11:
				...
				else if (_tcscmp(pstrClass, _T("GroupButton")) == 0)			pControl=new CGrouopButtonUI;
				break;
            case 14: 
            ...
            case 15:
				...
				else if( _tcscmp(pstrClass, _T("OwnerDrawButton")) == 0 )    pControl = new COwnerDrawButton;
                break;
            case 16:
