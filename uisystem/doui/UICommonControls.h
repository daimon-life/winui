...
public:
	...
	void SetBKImageBuddy(LPCTSTR pStrImage);//用来设置组合背景效果
...
protected:
	...
	CStdString m_sBkImagebuddy;//用来画第二张图像
};
...
public:
	...
	void SetSelectToolTip(LPCTSTR lptext);//设置选中提示
protected:
    bool m_bSelected;
...
protected:
	...
	int m_iWindowStyls;
	DWORD m_dwDefaultTextColor; //默认字体的颜色
	CStdString m_sDefaultString; //默认字符串。就是没东西的的时候显示的
};
